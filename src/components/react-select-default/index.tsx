...
const AsynDefaultSelectRegBase: React.FC<AsynCreatableSelectRegProps> = ({
  label = "",
  labelFontSize = "sm",
  labelFontWeight = "500",
  width = "",
  ...
  return (
    ...
    >
      <label
        className={classNames(
          `text-${labelFontSize} font-[${labelFontWeight}] select-none text-fontDark flex items-center gap-labelBase`
        )}
      >
        <span className={`text-${labelFontSize}`}>
          {" "}
      ...
      <div className="flex flex-col gap-2">
        ...
        {isError && <p className="text-sm text-fontError">This is required field</p>}
      </div>
    </div>
  );
};

export default AsynDefaultSelectRegBase;
